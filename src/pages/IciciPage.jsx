...
export default function MarketingPage() {
  ...
  const handleSearch = (query) => {
    if (query.trim()) {
      navigate('/chat/marketing', { state: { initialMessage: query } });
    }
  };
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg border border-gray-200">
                  <div className="flex justify-between items-start">
                    <p className="font-medium text-gray-900">FG Health Absolute campaign is currently running on Google Ads</p>
                ...
                <div className="p-4 rounded-lg border border-gray-200">
                  <div className="flex justify-between items-start">
                    <p className="font-medium text-gray-900">New brand guidelines available in Marketing Assets folder</p>
            ...
            <div className="p-6">
              <div className="p-4 rounded-lg border border-gray-200 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-gray-900">CAC dashboard</span>
                </div>
                <div className="flex items-center gap-2">
