...
export default function MiningPage() {
  ...
  const handleSearch = (query) => {
    if (query.trim()) {
      sessionStorage.setItem('initialChatQuery', query.trim());
      navigate('/chat/mining', { replace: true });
    }
  };
            ...
            <div className="p-6">
              <div className="space-y-4">
                <div className="p-4 rounded-lg border border-gray-200">
                  ...
                  <p className="font-medium text-gray-900">Investment houses predict a 10% rise in Copper prices. Read the full{" "}
                    <a href="https://www.reuters.com/article/us-copper-prices-idUSKBN2C028U" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">
                     report
                    </a>
                    </p>
                ...
                <div className="p-4 rounded-lg border border-gray-200">
                  <div className="flex justify-between items-start">
                    <p className="font-medium text-gray-900">Mining Workshop is set to take place on 30th April 2025</p>
            ...
            <div className="p-6">
              <div className="p-4 rounded-lg border border-gray-200 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700">has tagged you in a</span>
                  <span className="font-medium text-gray-900">GHG thread</span>
                </div>
                <div className="flex items-center gap-2">
